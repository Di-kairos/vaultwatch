...
> Homebrew. Для воспроизводимости фиксируй версию: `VW_VERSION=0.1.0` вместо `latest`.

> Текущий публичный релиз — **v0.1.1** (подписан, с `install.sh` + `SHA256SUMS`).
> Для воспроизводимости фиксируй его: `VW_VERSION=0.1.1` вместо `latest`.
